...
IS    
   BEGIN 
        ...
        VALUES(S_IDMASCOTA.CURRVAL,pNOMBRE,pTIPO,pRAZA,pENTRENAMIENTO,pDESCRIPCION,pTAMANO,pCOLOR,pENERGIA,pESPACIO,pPELAJE,pFOTO_ANTES,pFOTO_DESPUES,'EN ADOPCION',S_IDMASCOTA.CURRVAL,pTELEFONO_RESCATISTA,pCORREO_RESCATISTA) 
        SELECT * FROM dual;
        COMMIT;   
        RETURN 'Insertado';
   EXCEPTION
