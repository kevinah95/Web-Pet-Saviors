<?php 
	...
	$editadoMascota=json_decode(file_get_contents('php://input'));  //get user from json generated by login function in loginService.js
	...
	// echo((int)($editadoUsuario->es_rescatista));
